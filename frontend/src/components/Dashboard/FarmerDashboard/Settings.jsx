...
const Settings = () => {
  ...
  async function onProfileSubmit(e) {
    ...
    if (!isNameChanged && !isEmailChanged && !isPhoneChanged) {
      alert("No changes detected. Please edit a field to update.");
      return;
    }
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <div className="flex flex-col w-full md:col-span-2">
                  ...
                  <input
                    ...
                    className="h-10 w-full pl-3 rounded-lg border border-gray-300 bg-gray-50 text-gray-500 text-sm font-medium"
                  />
                </div>
          ...
          <form onSubmit={onAdditionalSubmit}>
            <div className="space-y-3 bg-white border border-slate-200 rounded-lg shadow-sm p-6">
              <div className="font-semibold flex items-center gap-2 mb-3 text-green-500">
                ...
                <p className="text-lg text-gray-800">Additional Information</p>
              </div>
