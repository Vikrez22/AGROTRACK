        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 border border-green-100 max-w-md flex-1">
          ...
          {signInWithEmail.error && (
            <div className="mb-6 p-4 bg-red-50 border border-red-200 rounded-lg">
              <p className="text-red-600 text-sm">{signInWithEmail.error.error}</p>
            </div>
          )}
          ...
          <p className="mt-6 text-center text-sm text-gray-600">
            ...
            <Link to="/signup" className="text-green-600 hover:text-green-700 font-medium hover:underline transition-colors">
              Sign up
            </Link>
          </p>
        </div>
