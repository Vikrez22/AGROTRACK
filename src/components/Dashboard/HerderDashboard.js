...
import { MapPin, MessageSquare, Bot, Menu, X, Navigation, Users, Map, AlertTriangle } from 'lucide-react';
          ...
          <div className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="bg-gradient-to-r from-green-500 to-green-600 text-white p-6 rounded-lg shadow-lg">
                ...
                <p className="text-sm mt-2 opacity-90">Available grazing areas</p>
              </div>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center gap-3 p-3 bg-green-50 rounded-lg">
                      ...
                      <div className="flex-1">
                        <p className="text-sm font-medium">Location shared successfully</p>
                    ...
                    <div className="flex items-center gap-3 p-3 bg-blue-50 rounded-lg">
                      ...
                      <div className="flex-1">
                        <p className="text-sm font-medium">Entered safe grazing zone</p>
                    ...
                    <div className="flex items-center gap-3 p-3 bg-purple-50 rounded-lg">
                      ...
                      <div className="flex-1">
                        <p className="text-sm font-medium">Message from farmer nearby</p>
                  ...
                  <div className="space-y-3 text-sm">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">Allow location sharing for conflict prevention</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">Use designated grazing areas when possible</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">Use community chat for coordination</p>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-lg shadow-lg p-6">
              ...
              <p className="text-gray-600 mb-6">
                Share your live location to help prevent conflicts and coordinate with farmers in your area.
              </p>
              <div className="flex items-center gap-4 p-4 bg-blue-50 rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Your location is being shared for safety monitoring</p>
                </div>
              </div>
            </div>
            <ResponsiveGeoTrackerHerder userId={userId} />
        ...
        return (
          <div className="space-y-6">
            <div className="bg-white rounded-lg shadow-lg p-6">
              ...
              <p className="text-gray-600 mb-6">
                Coordinate with farmers and other herders to prevent conflicts and share important updates.
              </p>
            </div>
            <div className="h-96">
        ...
        return (
          <div className="space-y-6">
            <div className="bg-white rounded-lg shadow-lg p-6">
              ...
              <p className="text-gray-600 mb-6">
                Get expert advice on livestock management, grazing practices, and conflict resolution.
              </p>
            </div>
            <div className="h-96">
