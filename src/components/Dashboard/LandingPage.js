...
import { 
  MapPin, Shield, AlertTriangle, Bot, Camera, FileText, 
...
const AgroTrackLandingPage = () => {
  ...
  const handleReportSubmit = (e) => {
    ...
    alert('Report submitted successfully! We will investigate and respond within 24 hours.');
  ...
  const features = [
    ...
    },
    {
      ...
      description: "Educational support and guidance for farmers and herders in multiple languages"
    },
    {
      icon: Radio,
      title: "Emergency Response",
      description: "Direct communication with law enforcement and emergency services"
    },
    {
      icon: Eye,
  ...
  const problemStats = [
    { number: "2,000+", label: "Deaths Annually", subtext: "Due to farmer-herder conflicts" },
    { number: "₦150B", label: "Economic Losses", subtext: "Annual crop destruction costs" },
    { number: "16 States", label: "Affected Regions", subtext: "Across Nigeria experiencing conflicts" }
  ];
          ...
          {mobileMenuOpen && (
            <div className="md:hidden bg-white border-t border-green-100 py-4">
              <div className="flex flex-col space-y-3">
                <a href="#problem" className="text-gray-600 hover:text-green-600 px-4 py-2">Problem</a>
                <a href="#solution" className="text-gray-600 hover:text-green-600 px-4 py-2">Solution</a>
                <a href="#features" className="text-gray-600 hover:text-green-600 px-4 py-2">Features</a>
                <button
                  onClick={() => setReportModalOpen(true)}
                ...
                <a href="/iot-dashboard" className="bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-700 mx-4 text-center">
                  Dashboard
                </a>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-600 mt-6 leading-relaxed">
                ...
                Real-time livestock tracking, smart geofencing, and instant alerts 
                protect crops and save lives.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 lg:p-12">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              <div>
                <h3 className="text-2xl font-bold text-gray-900 mb-6">The Root Causes</h3>
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-red-500 rounded-full mt-2"></div>
                    <p className="text-gray-700">Livestock straying into farmlands destroys crops worth billions annually</p>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-red-500 rounded-full mt-2"></div>
                    <p className="text-gray-700">Lack of communication between farming and herding communities</p>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-red-500 rounded-full mt-2"></div>
                    <p className="text-gray-700">No early warning systems to prevent boundary violations</p>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-red-500 rounded-full mt-2"></div>
                    <p className="text-gray-700">Traditional methods fail to track livestock in real-time</p>
                  </div>
                </div>
              </div>
              <div className="bg-red-50 p-8 rounded-xl">
                <AlertTriangle className="w-12 h-12 text-red-600 mb-4" />
                <h4 className="text-xl font-semibold text-red-900 mb-3">Critical Impact</h4>
                <p className="text-red-800">
                  Without immediate technological intervention, these conflicts will continue 
                  to escalate, threatening food security and community safety across Nigeria.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="bg-green-50 p-8 rounded-2xl">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-4">IoT Hardware</h3>
            ...
            <div className="bg-blue-50 p-8 rounded-2xl">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-4">Smart Geofencing</h3>
              <p className="text-gray-700 mb-6">
                Define safe grazing areas and restricted zones. Get instant alerts 
                when animals approach or enter forbidden areas.
              </p>
              <ul className="space-y-2 text-sm text-gray-600">
                <li className="flex items-center gap-2">
            ...
            <div className="bg-purple-50 p-8 rounded-2xl">
              ...
              <p className="text-gray-700 mb-6">
                Direct communication channels connect farmers, herders, and 
                law enforcement for rapid conflict resolution.
              </p>
              <ul className="space-y-2 text-sm text-gray-600">
                <li className="flex items-center gap-2">
      ...
      <section id="features" className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-16 bg-gradient-to-r from-green-600 to-green-700 rounded-2xl p-8 text-center text-white">
            ...
            <h3 className="text-2xl font-bold mb-4">Secure Marketplace - Coming Soon</h3>
            <p className="text-green-100 max-w-2xl mx-auto">
              Connect farmers and herders for peaceful trade and collaboration. 
              Pre-register now to be among the first to access our secure trading platform.
            </p>
          ...
          <div className="bg-white rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            <div className="p-6 border-b border-gray-200">
              <div className="flex items-center justify-between">
                <h3 className="text-2xl font-bold text-gray-900">Report an Incident</h3>
                <button
              ...
              <p className="text-gray-600 mt-2">
                Help us prevent conflicts by reporting incidents with detailed evidence.
              </p>
            </div>
            ...
            <form onSubmit={handleReportSubmit} className="p-6 space-y-6">
              ...
              <div>
                ...
                >
                  ...
                  <option value="trespassing">Illegal Grazing/Trespassing</option>
              ...
              <div>
                ...
                <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center">
                  ...
                  <p className="text-gray-600 mb-2">
                    {reportForm.evidence ? reportForm.evidence.name : 'Click to upload evidence'}
                  </p>
                  <button
                    type="button"
