...
import { 
  ...
  Bell, Settings, Radio, Car, FileText, Clock, Phone, Mail, Smartphone, Zap, Lock, Plus, Check, User
} from 'lucide-react';
    ...
    case 'reports':
      return (
        ...
        <div className="bg-white rounded-lg shadow-lg p-4 sm:p-6">
          <h2 className="text-xl sm:text-2xl font-bold mb-2 sm:mb-4">Incident Reports Management</h2>
                  ...
                  <tr className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center">
                        ...
                        <div className="ml-3">
                          <div className="text-sm font-medium text-gray-900">Adamu Garba</div>
                          <div className="text-sm text-gray-500">+234 803 123 4567</div>
                        </div>
                      </div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                  ...
                  <tr className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center">
                        ...
                        <div className="ml-3">
                          <div className="text-sm font-medium text-gray-900">Musa Ibrahim</div>
                          <div className="text-sm text-gray-500">+234 816 987 6543</div>
                        </div>
                      </div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                  ...
                  <tr className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center">
                        ...
                        <div className="ml-3">
                          <div className="text-sm font-medium text-gray-900">Fatima Aliyu</div>
                          <div className="text-sm text-gray-500">+234 701 234 5678</div>
                        </div>
                      </div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                  ...
                  <tr className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center">
                        ...
                        <div className="ml-3">
                          <div className="text-sm font-medium text-gray-900">Sani Mohammed</div>
                          <div className="text-sm text-gray-500">+234 812 345 6789</div>
                        </div>
                      </div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                  ...
                  <tr className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center">
                        ...
                        <div className="ml-3">
                          <div className="text-sm font-medium text-gray-900">Hauwa Abdullahi</div>
                          <div className="text-sm text-gray-500">+234 809 876 5432</div>
                        </div>
                      </div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
        ...
        <div className="space-y-6 m-6">
          ...
          {adminSettingsTab === "notifications" && (
            <div className="space-y-6">
              ...
              {/* Test Notifications */}
              <div className="bg-white rounded-lg shadow-lg p-6">
                <h3 className="text-lg font-semibold text-gray-800 mb-4">Test System</h3>
          ...
          {adminSettingsTab === "alerts" && (
            <div className="space-y-6">
              <div className="bg-white rounded-lg shadow-lg p-6">
                <h2 className="text-2xl font-bold mb-2">Alert Thresholds & Triggers</h2>
                <p className="text-gray-600">Configure system alert parameters and thresholds</p>
              </div>

              <div className="bg-white rounded-lg shadow-lg p-6">
                <h3 className="text-lg font-semibold text-gray-800 mb-4">System Thresholds</h3>
              ...
              <div className="bg-white rounded-lg shadow-lg p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="bg-red-50 p-4 rounded-lg border border-red-200">
                    ...
                    <p className="text-sm text-red-600 mb-3">Immediate response required</p>
                    <button className="w-full px-3 py-2 bg-red-500 text-white rounded-lg hover:bg-red-600">
                      Configure Critical
                    </button>
                  </div>
                  <div className="bg-yellow-50 p-4 rounded-lg border border-yellow-200">
                    <h4 className="font-semibold text-yellow-800 mb-2">Warning Alerts</h4>
                  ...
                  <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
                    <h4 className="font-semibold text-blue-800 mb-2">Info Alerts</h4>
                    <p className="text-sm text-blue-600 mb-3">General notifications</p>
          ...
          {adminSettingsTab === "communication" && (
            <div className="space-y-6">
              <div className="bg-white rounded-lg shadow-lg p-6">
                ...
                <p className="text-gray-600">Configure communication providers and emergency contacts</p>
              </div>

              <div className="bg-white rounded-lg shadow-lg p-6">
                <h3 className="text-lg font-semibold text-gray-800 mb-4">Provider Configuration</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-4">
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-2">Voice Call Provider</label>
                      <select className="w-full p-2 border border-gray-300 rounded-md">
          ...
          {adminSettingsTab === "advanced" && (
            <div className="space-y-6">
              <div className="bg-white rounded-lg shadow-lg p-6">
                ...
                <p className="text-gray-600">Configure AI, integrations, and advanced analytics</p>
              </div>
              ...
              <div className="bg-white rounded-lg shadow-lg p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {[
                    ...
                    <div key={index} className={`bg-gradient-to-br ${feature.color} p-4 rounded-lg border`}>
                      <div className="flex items-center justify-between mb-2">
              ...
              <div className="bg-white rounded-lg shadow-lg p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
                    <h4 className="font-semibold text-blue-800 mb-2">Satellite Integration</h4>
                    <p className="text-sm text-blue-600 mb-3">Real-time satellite imagery</p>
                    <button className="w-full px-3 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600">
                      Configure Satellite API
                    </button>
                  </div>
                  <div className="bg-green-50 p-4 rounded-lg border border-green-200">
                    <h4 className="font-semibold text-green-800 mb-2">Drone Integration</h4>
                    <p className="text-sm text-green-600 mb-3">Automated drone deployment</p>
          ...
          {adminSettingsTab === "security" && (
            <div className="space-y-6">
              <div className="bg-white rounded-lg shadow-lg p-6">
                <h2 className="text-2xl font-bold mb-2">Security & Privacy Settings</h2>
                <p className="text-gray-600">Configure system security and data protection</p>
              </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Encrypt all API communications</p>
                    </div>
                    <label className="relative inline-flex items-center cursor-pointer">
                      <input type="checkbox" defaultChecked className="sr-only peer" />
                      <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-green-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-green-500"></div>
              ...
              <div className="bg-white rounded-lg shadow-lg p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
                    <h4 className="font-semibold text-blue-800 mb-2">Backup Settings</h4>
                    <select className="w-full p-2 border border-gray-300 rounded-md mb-2">
          ...
          {adminSettingsTab === "farmers" && (
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-lg shadow-lg p-6">
                <div className="flex items-center justify-between mb-4">
                  <h3 className="text-lg font-semibold text-gray-800">Registered Farmers</h3>
                  ...
                  <table className="min-w-full border border-gray-200">
                    <thead className="bg-gray-100">
                      <tr>
                        ...
                        <th className="px-4 py-2 text-left text-sm font-medium text-gray-700 border-b">Contact</th>
                    ...
                    <tbody>
                      {[
                        { name: "John Doe", contact: "+2348123456789", location: "Lagos, Nigeria", status: "Active" },
                        { name: "Jane Smith", contact: "+2348987654321", location: "Abuja, Nigeria", status: "Pending" },
                        { name: "Samuel Green", contact: "+2348012345678", location: "Kano, Nigeria", status: "Suspended" },
                      ].map((farmer, index) => (
                        <tr key={index} className="hover:bg-gray-50">
                          <td className="px-4 py-2 border-b text-sm text-gray-800">{farmer.name}</td>
                          <td className="px-4 py-2 border-b text-sm text-gray-800">{farmer.contact}</td>
                          <td className="px-4 py-2 border-b text-sm text-gray-800">{farmer.location}</td>
