...
const Login = () => {
  ...
  const demoAccounts = [
    { role: 'Farmer', email: 'farmer@gmail.com', password: '12345678', dashboard: '/farmer-dashboard' },
    { role: 'Herder', email: 'herder@gmail.com', password: '12345678', dashboard: '/herder-dashboard' },
    { role: 'Law Enforcement Agency', email: 'admin@gmail.com', password: '12345678', dashboard: '/admin-dashboard' }
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-white flex items-center justify-center p-4">
      <div className="max-w-md w-full">
        ...
        {/* Demo Accounts Card */}
        <div className="mt-6 bg-white rounded-2xl shadow-xl p-6 border border-green-100">
          <div className="text-center mb-4">
            <Users className="w-6 h-6 text-green-500 mx-auto mb-2" />
            <h3 className="text-lg font-semibold text-gray-800">Demo Accounts</h3>
            <p className="text-sm text-gray-600">Click to auto-fill login credentials</p>
          </div>
